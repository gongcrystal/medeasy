...
function (a, b) {
  function c(b, c) {
    ...
    this.startLoading = function () {
      ...
      }, 1000 * this.settings.max_load_wait)))
    },
      ...
      A = function (b) {
        if (!v && j.sidebar_fixed && (f = l.find('.nav-list'), h = l.find('.sidebar-toggle').eq(0), i = l.find('.sidebar-shortcuts').eq(0), g = f.get(0))) {
          ...
          if (v = !0, 1 == b && (j.reset(), n && j.scroll_to_active(), n = !1), 'number' == typeof j.settings.smooth_scroll && j.settings.smooth_scroll > 0 && (f.css({
            ...
            'transition-duration': (j.settings.smooth_scroll / 1000).toFixed(2) + 's'
          }), s.css({
            'transition-property': 'top',
  ...
  a(document).on(ace.click_event + '.ace.widget', '.widget-header a[data-action]', function (b) {
    ...
    if (0 != e.length && !e.hasClass('ui-sortable-helper')) {
      ...
      if ('collapse' == g) {
        ...
        e.trigger(h = a.Event('toggle.ace.widget'), [
          i
        ]),
        f.toggle(i, c)
      } else if ('close' == g) {
...
function (a, b) {
  ...
  breadcrumbs_fixed: function (b, c, d, e) {
    ...
    f.isDefaultPrevented() ? !1 : (c && e !== !1 && ace.settingFunction.sidebar_fixed(null, !0, d), c ? a(b).addClass('breadcrumbs-fixed')  : a(b).removeClass('breadcrumbs-fixed'), d && ace.settings.saveState(b, 'class', 'breadcrumbs-fixed', c), void a(document).trigger('settings.ace', [
      'breadcrumbs_fixed',
      c,
      b,
      d
  ...
  main_container_fixed: function (b, c, d) {
    ...
    if ('string' == typeof b && (b = a(b).get(0)), !b) return !1;
    var e;
    if (a(document).trigger(e = a.Event('presettings.ace'), [
